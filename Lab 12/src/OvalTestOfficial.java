...
public class OvalTestOfficial
{
    ...
    @Test
    public void testOvalColorConstructor()
    {
    ...
    @Test
    public void testOvalUnfilledConstructor()
    {
        Assert.assertTrue("Oval fill incorrect.", o2.isFilled());
        Assert.assertTrue("Circle fill incorrect.", c2.isFilled());
    }
